...
class HeadEncoderClass
{
 public:
	...
	void init( EncoderAxis SelectInitAxis) ;
	void Reset(EncoderAxis SelectResetAxis);
	int32_t Read(EncoderAxis SelectReadAxis);


	
};

extern HeadEncoderClass HeadEncoder;
